...
add('python', {
    ...
    def {}({}):
        ...
        i(1, 'function_name'), i(2, '*args, **kwargs'), i(0, 'pass')
    })),
    s('while', fmt([[
    while {}:
        {}
    ...
    try:
        ...
        i(1, 'pass'), i(2, 'Exception'), i(0, 'pass')
    })),
    s('deft', fmt([[
    def {}({}) -> {}:
        {}
    ]], {
        i(1, 'function_name'), i(2, '*args, **kwargs'), i(3, 'type'), i(0, 'pass')
    })),
